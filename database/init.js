...
const { createRateioConfigTable, ensureDefaultRateioRules } = require('./rateio_config');
...
async function initializeDatabase(pool) {
  ...
  // Criar tabela de configuração de rateio
  await createRateioConfigTable(pool);
  await ensureDefaultRateioRules(pool);
